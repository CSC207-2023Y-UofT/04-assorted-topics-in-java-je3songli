...
class DrivableTrader extends Trader<Drivable> {
    ...
    /**
     * Takes in a Drivable object and returns its price + max speed when tradable.
     * When not tradable, returns Tradable.MISSING_PRICE.
     * @param item The item to get a price for
     */
    @Override
